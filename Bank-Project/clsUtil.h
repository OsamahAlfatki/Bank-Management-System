...
public:
   ...
   static string NumberToText(int Num) {
        ...
        if (Num >= 20 && Num <= 99) {
            string arr[] = { "","","Twenty","Thirty","Fourty","Fifty","Sixty","Seventy","Eigty","Ninety" };
        ...
        if (Num >= 200 && Num <= 999) {
            return NumberToText(Num / 100) + "Hunderds " + NumberToText(Num % 100);
        }

        if (Num >= 1000 && Num <= 1999) {

            return "One Thousand " + NumberToText(Num % 100);
        }
        ...
        if (Num >= 10000000 && Num <= 1999999) {
            return "One Million " + NumberToText(Num % 100000);
        }
